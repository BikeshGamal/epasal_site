...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="img/products/n4.jpg" alt="" width="100%" id="mainimg">
            <div class="small-img-group">
                <div class="small-img-col">
                    <img src="img/products/n1.jpg" alt="" width="100%" class="small_img">
                </div>
                <div class="small-img-col">
                ...
                <div class="small-img-col">
                    <img src="img/products/n4.jpg" alt="" width="100%" class="small_img">
                </div>
            </div>
        </div>
        <div class="single-pro-details">
            <h6>Home/Tshirt</h6>
            <h4>Men's victory T-shirt</h4>
            <h2>NRS 1390</h2>
            <select>
            ...
            <button class="normal" onclick="window.location.href='buy.html'">Buy Now</button>
            <h4>Product Details</h4>
            <span>Victory T-Shirt is a product of Royal Robe Apparel. This product reminds our customers that we have Victory in Christ and the battle has already been won! We don't for Victory, we fight from Victory! The Victory T-Shirt is the first line for the "I Am Royal" movement from Royal Robe Apparel.</span>
        </div>
    </section>
